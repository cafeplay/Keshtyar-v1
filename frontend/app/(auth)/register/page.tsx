            ...
            {step === 1 && (
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1">کد ۸ رقمی که هنگام خرید دریافت کرده‌اید</p>
                </div>
            ...
            {step === 2 && (
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1">هشدارهای SMS به این شماره ارسال می‌شود</p>
                </div>
              </div>
            )}
